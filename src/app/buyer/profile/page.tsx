...
import { currentBuyerProfile } from '@/lib/mock-data/profiles'
...
export default function BuyerProfilePage() {
  const profile = currentBuyerProfile

  return (
    <PageContainer narrow className="pb-24 lg:pb-10">
      <SectionHeader title="Προφίλ μου" subtitle="Στοιχεία επιχείρησης για αιτήματα." />
      ...
      <div className="flex items-center gap-2 mb-6 bg-green-50 border border-green-200 rounded-xl px-4 py-3">
        ...
        <span className="text-sm font-medium text-green-800">Επαληθευμένη επιχείρηση</span>
      </div>
      ...
      <div className="space-y-4">
        ...
        <InfoCard title="Στοιχεία Επιχείρησης">
          <div className="space-y-0">
            <InfoRow label="Επιχείρηση">{profile.companyName}</InfoRow>
            ...
            <InfoRow label="Τ.Κ.">{profile.postalCode}</InfoRow>
          </div>
        </InfoCard>

        {/* Document preference */}
        <InfoCard title="Προτιμήσεις">
          <InfoRow label="Παραστατικό">
            {profile.documentPreference === 'invoice' ? 'Τιμολόγιο' : 'Απόδειξη'}
          </InfoRow>
        </InfoCard>
